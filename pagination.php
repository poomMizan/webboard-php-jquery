...
function page_query($link, $sql, $rows_per_page=10) {
	...
	$row = mysqli_fetch_array($found_rows);
	$_total_rows = $row[0];
...
function page_echo_pagenums($half_size=5, $show_prev_next=true, $show_first_last=false) {
